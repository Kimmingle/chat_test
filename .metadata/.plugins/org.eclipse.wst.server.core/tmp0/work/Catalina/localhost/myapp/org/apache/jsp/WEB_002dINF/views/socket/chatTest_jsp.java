 ...
 * Generated at: 2024-05-31 06:57:02 UTC
...
public final class chatTest_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("	<title>채팅 테스트</title>\r\n");
      out.write("	<script src=\"https://code.jquery.com/jquery-latest.js\"></script>\r\n");
      out.write("	<script type=\"text/javascript\">\r\n");
      out.write("\r\n");
      out.write("	 $(function(){\r\n");
      out.write("	    var ws = new WebSocket(\"ws://localhost:8091/socket.do\");\r\n");
      out.write("		\r\n");
      out.write("		ws.onopen = function(e){  //서버에 연결되면\r\n");
      out.write("			console.log(\"info: connection open\");  //연결 메세지 출력\r\n");
      out.write("		}\r\n");
      out.write("		ws.onmessage = function(e){  //서버에 메세지 전송되면\r\n");
      out.write("			console.log(e.data);  //전달 메세지 출력\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      out.write("		ws.onclose = function(e){\r\n");
      out.write("			console.log(\"info: connection close\");\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      ...
      out.write("		}\r\n");
      out.write("		\r\n");
      out.write("		//여기서 뭔 행위를 해야 위에 함수들이 실행. 지금은 대기\r\n");
      out.write("		$(\"#btn\").on(\"click\", function(e){\r\n");
      out.write("            e.preventDefault();\r\n");
      out.write("            if (ws.readyState === WebSocket.OPEN) {\r\n");
      out.write("                ws.send($(\"#testInput\").val());\r\n");
      out.write("            } else {\r\n");
      out.write("                console.log(\"WebSocket is not open: readyState=\" + ws.readyState);\r\n");
      out.write("            }\r\n");
      out.write("        });\r\n");
      out.write("    });\r\n");
      out.write("	</script>\r\n");
      ...
      out.write("	<h2>Socket Test Page</h2>\r\n");
      out.write("	<input type=\"text\" id=\"testInput\">\r\n");
      out.write("	<button type=\"button\" id=\"btn\">전송</button>\r\n");
      out.write("</div>	\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
