...
//어노테이션을 사용하여 WebSocket 서버를 정의하면, 
//클라이언트와 서버 간의 WebSocket 연결이 맺어지고, 
//클라이언트와 서버 간의 메시지 교환을 할 수 있다. 
//그래서 컨트롤러를 사용하지 않고도 서버 측에서 클라이언트와 실시간으로 데이터를 주고받을 수 있게 된다.
...
//  @OnMessage
//  public void processImage(String imageData, Session session) {
//      // 이미지 데이터를 받아서 처리
//      // 예를 들어, 필요한 작업을 수행하거나 파일로 저장할 수 있습니다.
//      try {
